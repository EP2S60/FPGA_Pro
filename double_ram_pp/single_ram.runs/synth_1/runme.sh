...
HD_PWD='E:/R104A0/single_ram/single_ram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log single_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source single_ram.tcl
